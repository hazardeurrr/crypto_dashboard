...
export const IconAnalytics = IoMdAnalytics; // analytics
export const IconPodium = IoIosPodium; // podium
export const IconRocket = IoIosRocket; // rocket
export const IconPie = IoMdPie; // pie chart
